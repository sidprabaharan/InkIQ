...
export default function Quotes() {
  ...
  const getFilteredTotals = () => {
    ...
    const baseAmounts = {
      ...
      quotesSent: 4125320,
      quoteApprovalSent: 2834291,
      quoteApproved: 1323331
    };
    ...
    return {
      ...
      quoteApprovalSent: Math.round(baseAmounts.quoteApprovalSent * filterMultiplier),
      quoteApproved: Math.round(baseAmounts.quoteApproved * filterMultiplier)
    };
  };
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      amount: `$${filteredTotals.quoteApprovalSent.toLocaleString()}`,
      percentage: 35,
      period: "last month"
    },
    {
      title: "Quote Approved",
      amount: `$${filteredTotals.quoteApproved.toLocaleString()}`,
      percentage: 18,
      period: "last month"
    }
  ];
